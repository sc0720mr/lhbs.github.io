const alerts = [
    {
        message: "春節期間異動通知：2/16(一) ~ 2/22(日) 因應春節假期，社區巴士及公車班次皆有調整，請住戶們留意發車時間，避免久候。",
        startTime: "2026-02-16T00:00:00", // 快訊開始顯示的時間
        endTime: "2026-02-22T23:59:59"    // 快訊結束顯示的時間
    }
];
...
function isChineseNYDay() {
    const today = new Date().toLocaleDateString('zh-TW', { timeZone: 'Asia/Taipei' });
    const chineseNYDays = ["2026/2/16", "2026/2/17", "2026/2/18", "2026/2/19", "2026/2/20", "2026/2/21", "2026/2/22"]; // 設定颱風日的日期
    //console.log("Today's date:", today); // 顯示 today 的值
...
const chineseNYSchedule = {
    workday: {
        to: [
            ...
            ["09:50", "社巴", "南港火車站➡︎水蓮"],
            ["10:00", "591", "南港火車站➡︎水蓮"],
            ["10:10", "F913延", "忠三街口➡︎往國泰醫院"],
            ["10:50", "社巴", "南港火車站➡︎水蓮"],
            ["11:05", "F913", "汐湖橋口➡︎往國泰醫院"],
            ["11:50", "社巴", "南港火車站➡︎水蓮"],
            ["12:45", "社巴", "東湖捷運站➡︎水蓮"], 
            ["13:55", "社巴", "東湖捷運站➡︎水蓮"], 
            ["14:00", "F913延", "忠三街口➡︎往國泰醫院"],
            ["14:50", "社巴", "南港火車站➡︎水蓮"],
            ["14:50", "F913", "汐湖橋口➡︎往國泰醫院"],
            ["15:50", "社巴", "南港火車站➡︎水蓮"],
            ["16:20", "F913延", "忠三街口➡︎往國泰醫院"],
            ["16:50", "社巴", "南港火車站➡︎水蓮"],
            ["16:50", "F913", "汐湖橋口➡︎往國泰醫院"],
            ["17:00", "591", "南港火車站➡︎水蓮"],
            ["17:45", "社巴", "東湖捷運站➡︎水蓮"],
